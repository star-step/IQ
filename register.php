...
<body>
  <!-- NAVBAR -->
<header class="text-white py-2" style="background-color: #0074D9;">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
          ...
          <div class="card text-dark" style="background-color: #0074D9">
            <div class="card-header">
              ...
              <form class="" action="register.php" method="post">
                ...
                <div class="form-group">
                 ...
                 <label for="email"><span class="FieldInfo">Email:</span></label>
                  <div class="input-group mb-2">
                    <div class="input-group-prepend">
                      <?php  echo $EmailError ?>
                      <span class="input-group-text text-white" style="background-color: #0074D9"> <i class="fas fa-envelope"></i> </span>
                ...
                <input type="submit" name="Register" class="btn btn-block text-light" style="background-color: #0074D9" value="Register">
              </div>
            </div>
              </form>
